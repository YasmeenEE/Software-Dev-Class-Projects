...
public class CommonsYE extends JPanel {
	...
	public CommonsYE(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CommonsYE(create_Scene()));  // create an instance of the class
