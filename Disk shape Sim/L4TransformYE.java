...
public class L4TransformYE extends GroupObjects {
	...
	public static Shape3D ring_Side(int shape_key, Color3f clr) {
		...
		Point3f c_pts[] = L2StarYE.circle_Points(0, r, MAX_PTS);                
		...
		Appearance app = CommonsYE.set_Appearance(clr);
	...
	public L4TransformYE(int key) {
		super(ring_Side(key, CommonsYE.Green));
	}
}
